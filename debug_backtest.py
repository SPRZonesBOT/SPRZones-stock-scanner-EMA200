...
# ==============================================
# 🔥 NIFTY 50 STOCKS (Fast test ke liye top 10)
# ==============================================
# 🔥 Pehle 10 stocks test karo (fast)
TEST_STOCKS = [
...
# ==============================================
# 📈 EXACT SAME FUNCTIONS AS SCANNER (Copy-paste from scanner)
# ==============================================
...
def analyze_df(df):
    ...
    if ema_cross:
        # Use try-except to handle any version issues
        try:
